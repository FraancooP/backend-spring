...
//Tenemos que decirle cuales van a ser los path con los que va a reaccionar
...
public class ProductRestController {
	...
	//Esto lo interpeta de la siguiente manera:
	...
	//Esto lo interpeta de la siguiente manera:
	//http://localhost:8080/api/v1/products/by-name/Caramelo	
	...
	//Notar como mandamos status en http en funcion de lo que suceda!
	//eSO ES LO  que despues vemos en postman por ejemplo
}
